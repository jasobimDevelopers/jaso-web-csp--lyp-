      ...
      <el-tabs v-model="activeName" type="card" @tab-click="handleTabClick">
        <el-tab-pane label="检查项" name="first">
          <div>
            ...
            <quality-item-left :list="itemListData" @show="handleShow" @getList="getList"></quality-item-left>
            <el-dialog
...
import QualityItemLeft from './components/QualityItemLeft';
// import { questionTicketTypeList } from '@/filters';
// import { showGallery } from '@/utils/utils';

export default {
  name: 'QualityInfrastructure',
  components: {
    QualityItemLeft,
  },
  props: {
    ...
    handleSave() {
      if (this.natureAddOrEdit === '新增检查性质') {
        if (this.content === null || this.content === '') {
          ...
          addNature({ projectId: this.projectId, natureType: 0, content: this.content }).then((data) => {
            if (data) {
